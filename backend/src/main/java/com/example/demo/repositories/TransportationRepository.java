...
public interface TransportationRepository extends JpaRepository<Transportation, Long> {
  ...
  @Query(
      "SELECT t FROM Transportation t "
          ...
          + "AND od = :dayOfWeek")
  List<Transportation> findUsableAirportsByOriginLocationIdAndOperatingDay(
      Long originLocationId, int dayOfWeek);
  ...
  @Query(
      "SELECT t FROM Transportation t "
          ...
          + "AND t.transportationType != 'FLIGHT'"
          + "AND od = :dayOfWeek")
  List<Transportation> findUsableAirportsByDestinationLocationIdAndOperatingDay(
      Long destinationLocationId, int dayOfWeek);
