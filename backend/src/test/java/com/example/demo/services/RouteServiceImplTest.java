...
public class RouteServiceImplTest {
  ...
  void setUp() {
    ...
    List<LocationCreateDTO> locationCreateDTOs =
        List.of(
    ...
    List<Location> locations =
        locationCreateDTOs.stream()
            .map(
                dto ->
                    new Location(
                        dto.getName(), dto.getCountry(), dto.getCity(), dto.getLocationCode()))
    ...
    List<TransportationCreateDTO> transportationCreateDTOs =
        List.of(
            new TransportationCreateDTO(
                locationIdMap.get("IST"),
                locationIdMap.get("SZF"),
                TransportationType.FLIGHT,
                Set.of(1, 2, 3, 4, 5, 6, 7)),
            new TransportationCreateDTO(
                locationIdMap.get("IST"),
                locationIdMap.get("ESB"),
                TransportationType.FLIGHT,
                Set.of(1, 2, 3, 4, 5, 6, 7)),
            new TransportationCreateDTO(
                locationIdMap.get("ESB"),
  ...
  void testFindMatchingRoutes_DirectRoute() {
    ...
    List<RouteDTO> routes =
        routeService.findMatchingRoutes(originLocationCode, destinationLocationCode, travelDate);
